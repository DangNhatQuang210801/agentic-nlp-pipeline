### Universal Dependencies Data Prep

## Environment stuff setting
...
data_dir = repo_root / "data" / "externaml"
...
tw_path = Path("data/UD_Taiwanese-Ckiplab/data/sinica_ud.conllu")
tw_path_train = Path("data/UD_Taiwanese-Ckiplab/data/sinica_ud-train.conllu")
test_temp = Path("data/UD_Taiwanese-Ckiplab/data/sinica_ud-test.conllu")
...
ud_path_train = Path("data/UD_Taiwanese-Ckiplab/data/sinica_ud-train.conllu")
ud_path_test = Path("data/UD_Taiwanese-Ckiplab/data/sinica_ud-test.conllu")

new_train = Path("data/UD_Taiwanese-Ckiplab/data/zh_ckiplab-ud-train.conllu")
new_test = Path("data/UD_Taiwanese-Ckiplab/data/zh_ckiplab-ud-test.conllu")
...
train_tw = Path("data/UD_Taiwanese-Ckiplab/data/zh_ckiplab-ud-train.conllu")
train_tw_new = Path("data/UD_Taiwanese-Ckiplab/data/zh_ckiplab-ud-train-new.conllu")
train_tw_dev = Path("data/UD_Taiwanese-Ckiplab/data/zh_ckiplab-ud-dev.conllu")
    ...
    for split_name, files_found in splits_map.items():
        if files_found:
            for fp in files_found:
                ...
                token_count = sum(len(sent.words) for sent in doc.sentences) # added token counts
