...
Five Universal Dependencies (UD) treebanks were chosen to span a range of resource levels: English @zeldes-2017-gum, Marathi @ravishankar-2017-marathi, Taiwanese, Low Saxon @siewert-rueter-2024-low, and Vietnamese @nguyen-etal-2009-vtb. Although the project initially had only 4 lower-resource languages, English as a benchmark for the evaluation was also added at a later stage. Taiwanese, being a lower-resource language, did not have the official UD site, so the converted version of Sinica Treebank @hsieh-etal-2022-sud, one of the major Mandarin Chinese treebanks, to Universal Dependencies was implemented. The columns were rearranged so that the data matched the official UD format and could be called by the Stanza NLP toolkit.
